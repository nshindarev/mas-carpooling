    ...
    protected void setup() {
        ...
        try {
            if (!isAutoGenerateAgents){
                ...
                AgentController nick    = cc.createNewAgent("agent_nick",    "dreamteam.carpooling.appl.CitizenAgent", new Object[] { 1, 11, 3, 1 });
                AgentController iskrich = cc.createNewAgent("agent_iskrich", "dreamteam.carpooling.appl.CitizenAgent", new Object[] { 1, 7, 3, 1 });
                AgentController starosta = cc.createNewAgent("agent_starosta", "dreamteam.carpooling.appl.CitizenAgent", new Object[] { 1, 11, 3, 1 });
